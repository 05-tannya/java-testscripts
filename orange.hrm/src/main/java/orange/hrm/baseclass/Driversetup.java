...
import orange.hrm.utility.Utility;
...
// creating constructor of base class 
		 public Driversetup() throws IOException {
			// Reading the properties file 
				p = new Properties();
			    FileInputStream s = new FileInputStream("C:\\Users\\mittal.tannya\\eclipse-workspace1\\orange.hrm\\src\\main\\java\\orange\\hrm\\config\\config.properties");
				p.load(s);
			}
